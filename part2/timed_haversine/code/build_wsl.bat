...
set CODE=C:\Users\ams56\work\pap\part2\timed_haversine\code
set BUILD=C:\Users\ams56\work\pap\part2\timed_haversine\build
set IncludeDirs=/IC:\Users\ams56\work\pap\part2\shared /IC:\Users\ams56\work\pap\part2\timer /IC:\Users\ams56\work\pap\part2\code
...
pushd %BUILD%
"%CLANGCL%" %IncludeDirs% %CommonCompilerFlags% %CODE%\timed_haversine_main.c /link %CommonLinkerFlags% /OUT:timed_haversine_main.exe
if %ERRORLEVEL% NEQ 0 exit /b %ERRORLEVEL%
echo timed_haversine_main.exe: OK
popd

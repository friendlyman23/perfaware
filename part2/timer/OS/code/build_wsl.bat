...
set CODE=C:\Users\ams56\work\pap\part2\timer\OS\code
set BUILD=C:\Users\ams56\work\pap\part2\timer\OS\build
...
pushd %BUILD%
"%CLANGCL%" %IncludeDirs% %CommonCompilerFlags% %CODE%\os_timer_main.c /link %CommonLinkerFlags% /OUT:os_timer_main.exe
if %ERRORLEVEL% NEQ 0 exit /b %ERRORLEVEL%
echo os_timer_main.exe: OK
popd
